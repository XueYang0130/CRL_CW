...
from agents import SACAgent, SemanticRoutedFrozenTransferCriticAgent
...
def build_agent(
    ...
    del total_tasks
    return SemanticRoutedFrozenTransferCriticAgent(
        **agent_kwargs,
...
METHOD = make_success_replay_method(
    ...
    defaults={
        ...
        "critic_route_manifest": "configs/critic_routes/cw10_v3_schema_routes.json",
    },
