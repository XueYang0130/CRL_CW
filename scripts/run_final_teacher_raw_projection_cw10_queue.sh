...
for seed in 1 2 3 4 5; do
    run_name="success_replay_final_teacher_raw_pcgrad_projection_cw10_v3_v1_500k_seed${seed}"
    ...
    if ! "${PYTHON_BIN}" -u scripts/run.py \
        --mode continual \
        --method success_replay_final_pcgrad \
        --env-version v3 \
        ...
        --bc-gradient-strategy pcgrad_sac_priority \
